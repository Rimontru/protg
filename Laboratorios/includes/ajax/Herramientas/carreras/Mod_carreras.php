...
if (empty($_POST['plantel']) || empty($_POST['clvCarrera']) || empty($_POST['nomCarrera']) || empty($_POST['revoe']) || empty($_POST['fechaExp']) || empty($_POST['modalidad']) || empty($_POST['nomTitulo']) || empty($_POST['academico']) || empty($_POST['edificio'])) {
