...
//    
//    $CatPermisos = "";
//    $ResultMenucito = $Obras->conCatMenu($RowCatObra["Fk_Departamento"]);
...
//
//   $Fila .="$CatPermisos</select>";   
   $Fila .= "<a href='' class='elimina' id='EliminarPermiso' title= 'Eliminar'><img src='img/iconos/delete.png'></a></td>";
   $Fila .= "</tr>";  
   $contador=$contador+1;
}
