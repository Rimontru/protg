...
$error_login_ms[2]="Password el Usuario no existe";
$error_login_ms[3]="Password no valida";
$error_login_ms[4]="Usuario no existe";
$error_login_ms[5]="No esta autorizado para realizar esta acción o entrar en esta página";
$error_login_ms[6]="Acceso no autorizado! Registrese";
$error_login_ms[7]="Ya existe un Usuario en Linea";
?>
