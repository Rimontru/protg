	...
	Vanadium
			.addValidatorTypes( [
					...
					[
							...
							function(a) {
								return Vanadium.validators_types.empty.test(a)
										|| (/^(([0-9]{0,9})\.([0-9]{2}))$/.test(a))
							},
							"Por favor, introduzca una medida válida en este campo. ej. 123.25" ],
                                        [
							"gps",
							function(a) {
								return Vanadium.validators_types.empty.test(a)
										|| (/^-?(([0-9]{0,9})\.([0-9]{1,9}))$/.test(a))
                                                                                    //|| (/^-?[0-9]+(\.[0-9]{1,9})?$/.test(a))
							},
							"Por favor, introduzca una coordenada válida en este campo. ej. 16.753263 ó -93.114896" ],
                                        [
							"tel",
							function(a) {
								return Vanadium.validators_types.empty.test(a)
							...
							"Por favor, introduzca un numero de Telefono Valido de 10 digitos ej. 9610005483" ],
					[
							"obs",
							function(a) {
								return Vanadium.validators_types.empty.test(a)
										|| (/^[0-9a-zA-ZáéíóúÁÉÍÓÚäëïöüÄËÏÖÜàèìòùÀÈÌÒÙñÑ\s\'\:\.\,\;\#\%\=\!\?\¡\¿\&\-\_\/\°\(\)-]+$/.test(a))
							},
							"Por favor, introduzca una breve Observación" ],
                                        [
							"number",
							function(a) {
								return Vanadium.validators_types.empty.test(a)
					...
					[
							...
							"porcentaje",
                                                       	function(a) {
								return Vanadium.validators_types.empty.test(a)
										|| (/^((([0-9]{1,3}[0-9]{3,3}|[0-9]{1,3})?[0-9]{1,3})\.([0-9]{2}){1})$/.test(a))
							},
							"Por favor, introduzca un porcentaje valido ej. (95.27)" ],
                                        [
							"monto",
                                                       	function(a) {
								return Vanadium.validators_types.empty.test(a)
							...
							"Por favor, introduzca un numero con punto decimal ej. (123.00)" ],
					[
							"monto2",
                                                       	function(a) {
								return Vanadium.validators_types.empty.test(a)
							...
							"No se permite el uso de Comillas simples ' " ], 
					[
							"digits",
							function(a) {
								return Vanadium.validators_types.empty.test(a)
					...
					[
							...
							function(a) {
								return Vanadium.validators_types.empty.test(a)
										//|| (/^(([0-1]|[0-2])|([2][0-3])):([0-5]?[0-9]) (AM|PM)$/.test(a))
                                                                            || (/^(0[1-9]|1\d|2[0-3]):([0-5]\d) (AM|PM)$/.test(a))
                                                                            //(Por ejemplo 10:45:23)
							},
							"Por favor, introduzca una Hora válida en este campo. ej. 12:00 AM ó 05:11 PM" ],
					[
							"asciialpha",
							function(a) {
								return Vanadium.validators_types.empty.test(a)
