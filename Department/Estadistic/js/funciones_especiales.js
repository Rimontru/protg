...
function cargaPantalla(file,content){
	$.ajax({
		beforeSend: function(){
			$('#'+content).html("<div style='text-align:center;margin-top:250px;'><img src='images/frontend/loading.gif' width='40' height='40'><br><h3 style='font-family:Arial,Helvetica,sans-serif;color:#999;font-size:16px;'>Trabajando en ello... Espere por favor</h3><div>");
		}, 
		url:file,
		success: function(e){
