...
function verTituloAtras(pk_alumno, fk_nivelestudio){
    ...
    alertify.prompt("Ingrese Fecha de Registro (0000-00-00)", function(g, fechR){
        if(g){
                ...
                alertify.prompt("Ingrese el N&uacute;mero de Foja", function (e, str) {
                    ...
                    if (e){
                            // user clicked "ok"
                            alertify.prompt("Ingrese el Numero de Libro", function (f, registro) {
                                // str is the input text
                                if (f) {
                                    // user clicked "ok"
                                    alertify.prompt("No. de Folio ", function(d,folio){
                                        if(d){
                                            // if(fk_nivelestudio=='2'){
                                            window.open('includes/ajax/Tramites/TomaProtesta/Reportes/mioTituloAtras.php?pk_alumno='+pk_alumno + "&Fojanumero=" + str + "&nuRegistro=" + registro + "&folio=" + folio + "&fecha="+fechR+ "&nivel="+fk_nivelestudio);
                                            //}else if(fk_nivelestudio=='3' || fk_nivelestudio=='4'){
                                            //    window.open('includes/ajax/Tramites/TomaProtesta/Reportes/mioTituloAtrasMaestria.php?pk_alumno='+pk_alumno + "&Fojanumero=" + str + "&nuRegistro=" + registro + "&folio=" + folio+ "&fecha="+fechR);
                                            //}
                                        }
                                    }, "X-0");
                                }
...
function verActaExamenFrente(pk_alumno,fk_nivelestudio){
   if (fk_nivelestudio=='3' || fk_nivelestudio=='4' ){
	    ...
	    alertify.set({ labels: {
            ...
            alertify.prompt("No. de Folio", function (e, str) {
            // str is the input text
            if (e) {
                // user clicked "ok"
                window.open('includes/ajax/Tramites/TomaProtesta/Reportes/mioActaExamenFrenteMaestria.php?pk_alumno=' + pk_alumno + "&fk_nivelestudio=" + fk_nivelestudio + "&folio="+str);
            }
        }, "");
        ...
        alertify.set({ labels: {
            ...
            if (e) {
                // user clicked "ok"
                window.open('includes/ajax/Tramites/TomaProtesta/Reportes/mioActaExamenFrente.php?pk_alumno=' + pk_alumno + "&folio="+str);
            }
        }, "");
...
function verTituloFrente(pk_alumno,fk_nivelestudio){
    ...
    alertify.prompt("Ingrese Fecha de Expedición (1999-99-99)", function (e, str) {
        // str is the input text
        if (e) {

            if(fk_nivelestudio=='2'){
                window.open('includes/ajax/Tramites/TomaProtesta/Reportes/mioTituloFrente.php?pk_alumno='+pk_alumno+'&fecha='+str);
                //window.open('includes/ajax/Tramites/TomaProtesta/Reportes/tituloFrenteAntes.php?pk_alumno='+pk_alumno+'&fecha='+str);
            }else if(fk_nivelestudio=='3' || fk_nivelestudio=='4'){
        	   window.open('includes/ajax/Tramites/TomaProtesta/Reportes/mioTituloFrenteMaestria.php?pk_alumno='+pk_alumno + "&fk_nivelestudio=" + fk_nivelestudio+'&fecha='+str);
            }
        }
    },"2017-05-04"); 
...
////////////////////////////////////
function verTituloF(pk_alumno,fk_nivelestudio){
     $('#contenido_modal').html('<iframe src="includes/ajax/Tramites/TomaProtesta/Reportes/mioTituloFrente.php?pk_alumno='+pk_alumno+'" width="100%" height="100%" scrolling="no" frameborder="0"></iframe>');	
     AbrirModalGeneral('ModalPrincipal',900,600);
}
////////////////////////////////////
...
////////////////////////////////////////////////////////////////
////////////////REPORTE DE INVITACION PARA SINODALES 
////////////////////////////////////////////////////////////////
function invitacionSinodal(){
    var sinodal = $('#f_ReporteInvitacion #cmb_sinodal').val();
    var rangoFecha = $('#f_ReporteInvitacion #txt_fechaToma').val();
    var nivel = $('input:radio[name=nivel]:checked').val();
    var cargo = $('#f_ReporteInvitacion #cmb_cargosinodal').val();
    //console.log("nivel: " + nivel);
    window.open('includes/ajax/Sinodales/Reportes/mioInvitacionSinodales.php?sinodal=' + sinodal + "&rangoFecha=" + rangoFecha + "&nivel=" + nivel+ "&cargo=" + cargo);
