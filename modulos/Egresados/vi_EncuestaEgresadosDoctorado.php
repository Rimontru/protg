    ...
    <div id='wrap'>
        <div id="page-heading">
            <ol class="breadcrumb">
                ...
                <li><a>Egresados</a></li>
                <li class="active">Encuesta Doctorado</li>
            </ol>

            <h1>Encuesta Doctorado</h1>
            <div class="options">
        ...
        <div class="container">
            ...
            <div class="panel">
                <div class="panel-heading">
                    <h4><i class="icon-cloud"></i> Encuesta Doctorado</h4>
                    <div class="options">
                        <ul class="nav nav-tabs">
                            <li class="active">
                                <a href="#home1" data-toggle="tab"> Encuesta Doctorado</a>
                            </li>
                                    ...
                                    <div class="panel panel-sky">
                                        ...
                                        <div>
                                            ...
                                            <div class="modal-body">
                                                <form action="#" class="form-horizontal" id="frm_busqueda_encuestaEgresadosDoctorado" name="frm_busqueda_encuestaEgresadosDoctorado"/>   
                                                <fieldset>
                                        ...
                                        <div id="FormularioEditarAlumno" style="display: none;">
                                            ...
                                            <form action="#" class="form-horizontal" id="frm_datosEncuestaDoctorado" name="frm_datosEncuestaDoctorado"/>   
                                            <fieldset>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="panel panel-midnightblue">
                                                            ...
                                                            <div class="panel-body">
                                                                ...
                                                                <input type="hidden" class="form-control :apostrofe" name="pk_encuestadoctorado" id="pk_encuestadoctorado" />
