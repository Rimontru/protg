    ...
    <div id='wrap'>
        <div id="page-heading">
            <ol class="breadcrumb">
                ...
                <li class="active">Asignar Folios a Alumnos </li>
            </ol>

            <h1>Asignar Folios a Alumnos</h1>
            <div class="options">
        ...
        <div class="container">
            ...
            <div class="panel">
                <div class="panel-heading">
                    <h4><i class="icon-cloud"></i> Asignar Folios a Alumnos</h4>
                    <div class="options">
                        <ul class="nav nav-tabs">
                            <li class="active">
                                <a href="#home1" data-toggle="tab"> Asignar Folios a Alumnos</a>
                            </li>
                                    ...
                                    <div class="col-md-12">
                                        <div class="panel panel-midnightblue">
                                            <div class="panel-heading">
                                              ...
                                              <form action="" class="form-horizontal" name="f_AsignarFolios" id="f_AsignarFolios" />
                                               <div class="panel-body collapse in"> 
                                                       <div class="form-group">
                                                        ...
                                                        <!--Boton sinodal--> 
                                                        <center>
                                                         <button name="GuardarFolios" id="ReporteAsignarFoliosAlumnos" class="btn btn-primary start" type="submit">
                                                            <i class="fa fa-save"></i>
                                                            <span>Asignar Folios</span>
                                                        </button>  
                                                        </center>
                                                        <!--End Boton Sinodal-->    
                                                </fieldset>  
                                    ...
                                    <div class="col-md-12">
                                        <div class="panel panel-midnightblue">
                                            <div class="panel-heading">
                                              ...
                                              <form action="" class="form-horizontal" id="AltaFoliosExamenInstitucional"  name="AltaFoliosExamenInstitucional" />
                                               <div class="panel-body collapse in"> 
