                                    ...
                                    <div class="panel panel-sky">
                                        ...
                                        <div>
                                            ...
                                            <div class="modal-body">
                                                <form action="#" class="form-horizontal" id="frm_busquedaSecretariaEducacionReportes" name="frm_busquedaSecretariaEducacionReportes"/>   
                                                <fieldset>
                                                        ...
                                                        <div class="panel panel-midnightblue">
                                                            ...
                                                            <div class="panel-body">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-sm-6">
                                                                        <input type="text" class="form-control :required :apostrofe"  name="curp" id="curp" title="ESTE CAMPO ES REQUERIDO"/>
                                                                    </div>
                                                                </div>


                                                                <div class="form-group">
                                                                    <label class="col-sm-3 control-label" for="generacionSecre">Generación Secretaria</label>
                                                                    <div class="col-sm-6">
                                                            ...
                                                            <div class="panel-body">
                                                                ...
                                                                <div class="form-group">
                                                                  ...
                                                                  <div class="form-group">
                                                                    ...
                                                                    <div class="col-sm-6">
                                                                    <input type="text" class="form-control :apostrofe :required"  name="FechaExamen" id="FechaExamen" />
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-sm-6">
                                                                        <input type="text" class="form-control :apostrofe :required"  name="NumeroAutorizacion" id="NumeroAutorizacion" />
                                                                    </div>
                                                                </div>
                                                               ...
                                                               <div class="form-group">
                                                                    ...
                                                                    <div class="col-sm-6">
                                                                        <input type="text" class="form-control :apostrofe :required"  name="FolioActa" id="FolioActa" />
                                                                    </div>
                                                                </div>
