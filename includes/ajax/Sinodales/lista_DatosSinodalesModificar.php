...
<?php do { ?>        
        <tr>
            ...
            <td class="center" style="width: 100px;">               
                <a data-toggle="modal" href="#InstitucionEdit" class="btn btn-info"  onClick="ModificarSinodales('<?php echo $sinodales_row['pk_sinodal']?>','<?php echo $sinodales_row['pk_carreras']?>')"><i class="icon-edit"></i></a>
            </td>
        </tr>
