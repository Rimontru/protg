...
" style="border-collapse: collapse;">
  <tr>
     ...
     <td rowspan="6" align="center" width="20" height="28"><div align="center"><img src="../../../../assets/img/fimpes.png" width="100"  /></div></td>
  </tr>
  <tr>
  ...
  <tr>
     <td align="center" height="40"><div align="center"><strong>&nbsp;</strong></div></td>
    ...
    if ($Result) {
        while($row2 = mysql_fetch_assoc($Result)){
            ...
            if ($row2[fk_carreras] == "12") {
            	...
            	if( $_GET['fk_nivelestudio'] >= 3)
            		//Tesis Profecional
					if ($row2[pk_titulacion] == "10")               
						$precio="$500";
					else
						$precio="$250";
            	else
            	{
					//Tesis Profecional                 //EXAMEN COLECTIVO
					if ($row2[pk_titulacion] == "7" || $row2[pk_titulacion] == "12")               
						$precio="$300";
					else
						$precio="$200";
            	 }
              // //EXAMEN COLECTIVO
              // elseif ($row2[pk_titulacion] == "12") {
              //     $precio="$300";
              // }
//             //Curso de Titulacion
...
if($row2[pk_sinodal]<="1091" || $row2[pk_sinodal]>="1093" ){
             ...
             $html.="
                    <tr>
                        <td colspan='5' align='center'  height='28'><div align='center'><strong>$row2[nombreCarrera]</strong></div></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td rowspan='4' style='border-width: 0px;border: solid;' width='';class='Estilo1'>Sinodales</td>
...
$mpdf->WriteHTML($html);
$mpdf->Output("Reporte_Sinodales_por_Carrera_".$today.".pdf",'I');
