...
<!--            <td class="center">
            ...
            <td class="center" style="width: 100px;">               
                <a data-toggle="modal" href="#InstitucionEdit" class="btn btn-warning"  onClick="loadDatasAlumnoForCertificacion('<?php echo $alumnos_row['pk_alumno']?>')"><i class="icon-file-text"></i></a>
            </td>
        </tr>
