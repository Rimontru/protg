...
$result = $consult->ConAlumnosporMatriculaSecretariaEducacion($matricula_buscar);
...
<div class="alert alert-dismissable alert-danger">
    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
     <p>Errores:</p>
     <p>El Alumno no se ha registrado en Tramite para Toma de Protesta</p>
...
<?php do { ?>        
        <tr>
            ...
            <td class="center" style="width: 100px;">               
                <a data-toggle="modal" href="#InstitucionEdit" class="btn btn-info"  onClick="AltaSecretariaEducacion('<?php echo $alumnos_row['pk_alumno']?>')"><i class="icon-edit"></i></a>
            </td>
        </tr>
