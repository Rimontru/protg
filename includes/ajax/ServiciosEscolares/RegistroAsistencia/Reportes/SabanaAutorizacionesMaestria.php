...
if($fk_carreras=="6" || $fk_carreras=="7" || $fk_carreras=="11" || $fk_carreras=="13"  || $fk_carreras=="27"){
    ...
    $carreraAutorizacion=strtoupper($carreraReporte);
}else{
    $carreraAutorizacion=strtoupper("".$carreraReporte);
...
<body>
<table width="1142" height="424" border="0" style="border-collapse: collapse;" class="Estilo1">
  <tr>
    <td colspan="2" rowspan="6"><div align="center"><img src="../../../../../assets/img/hechos.jpg" width="183" height="100" /></div></td>
    <td height="19" colspan="14"><center><div align="center" class="Estilo1"><strong>SECRETARIA DE EDUCACION</strong></div></center></td>
    <td colspan="2" rowspan="6"><div align="left"><img src="../../../../../assets/img/secretaria.jpg" width="154" height="110" /></div></td>
  </tr>
  <tr>
    <td height="19" colspan="14"><center><div align="center" class="Estilo1" ><strong>SUBSECRETARIA DE EDUCACION ESTATAL</strong></div></center></td>
  </tr>
  <tr>
    <td height="19" colspan="14"><center><div align="center" class="Estilo1"><strong>DIRECCION DE EDUCACION SUPERIOR</strong></div></center></td>
  </tr>
  <tr>
    <td height="19" colspan="14"><center><div align="center" class="Estilo1"><strong>DEPARTAMENTO DE SERVICIOS ESCOLARES Y BECAS</strong></div></center></td>
  </tr>
  <tr>
    <td height="19" colspan="14"><center><div align="center" class="Estilo1"><strong>'.$nombreInstitucion.'</strong></div></center></td>
  </tr>
  <tr>
    <td height="19" colspan="14"><center><div align="center" class="Estilo1"><strong>CONTROL DE No. DE AUTORIZACIONES DE EXAMEN DE GRADO<strong></div></center></td>
  </tr>
  ...
  <tr>
    <td height="21" colspan="" style="border-width: 1px;border: solid;"><div align="left"><strong>ESCUELA:</strong></div></td>
    ...
    <td colspan="6" style="border-width: 1px;border: solid;"><div align="center">'.$carreraAutorizacion.'</div></td>
  </tr>
  <tr>
    <td height="21" colspan="" style="border-width: 1px;border: solid;"><strong>UBICACION:</strong></td>
    <td colspan="17" style="border-width: 1px;border: solid;"><div align="center">'.$direccion.', '.$ciudad.', '.$estado.'.</div></td>
  </tr>
  <tr>
    <td height="21">&nbsp;</td>
    <td>&nbsp;</td>
...
$mpdf=new mPDF('','Legal','',''); 
$mpdf->AddPage('L','','','','30','30','30','10','10','','');
$mpdf->WriteHTML($res);

$mpdf->SetHTMLFooter($footer);
$mpdf->Output("Reporte_Sabana_Autorizaciones_Maestria" . $today.'.pdf', 'D');
?> 
