...
///TERMINA LA CLASE EXTENDIDA DE FPDF
 ...
 $Funciones = new MisFunciones;
      ...
      if($result){
          ...
          // NOMBE DEL TITULO, VALIDAMOS LA CANTIDAD DE LOS CARACTERES PARA CONOCER SU TAMAÑO
            ...
            //NOMBE DEL ALUMNO, VALIDAMOS LA CANTIDAD DE LOS CARACTERES PARA CONOCER SU TAMAÑO
              ...
              $nombreAlumno = $Funciones->str_to_may($nombreAlumno);
        ...
        #$articuloNo = array('El', 'Los', 'La', 'Las', 'Lo', 'Al', 'Del', 'Un', 'Una', 'Unos', 'Unas', 'Este', 'Ese', 'Aquel', 'Mi', 'Tu', 'Su', 'A', 'Ante', 'Con', 'E', 'Desde', 'En', 'Por', 'Que', 'Si', 'Pero', 'Ni', 'Porque', 'Pues', 'Aunque', 'Como', 'Cuando', 'De', 'Y', 'Para', 'Le', 'Les', 'Me', 'Se', 'Mi');

				#$articuloYes = array('el', 'los', 'la', 'las', 'lo', 'al', 'del', 'un', 'una', 'unos', 'unas', 'este', 'ese', 'aquel', 'mi', 'tu', 'su', 'a', 'ante', 'con', 'e', 'desde', 'en', 'por', 'que', 'si', 'pero', 'ni', 'porque', 'pues', 'aunque', 'como', 'cuando', 'de', 'y', 'para', 'le', 'les', 'me', 'se', 'mi');
        ...
        if($row['fk_titulacion']==2){
        ...
        }else if ( $row['fk_titulacion'] == 7 ) {
          $tesis = strtr($row['nombreTesis'], "ÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏÐÑÒÓÔÕÖØÙÜÚ", "àáâãäåæçèéêëìíîïðñòóôõöøùüú");
          $tes = ucwords(strtolower($tesis));

          $myTesis = str_replace('De', 'de', $tes);
          $myTesis = str_replace('La', 'la', $myTesis);
          $myTesis = str_replace('En', 'en', $myTesis);

          $opciondetitulo = $titulado. ' "'.$myTesis.'"';
          ...
          $opciondetitulo=$titulado;
                 ...
                 //$name_sin_acentos = $Funciones->TruncateTilde($nombreAlumno);
            ///////////////////////////////////
            ...
            //////////////////////////////////
                ...
                //contenido o cuerpo
                    ...
                    $pdf->SetXY(48, 31);
                    $pdf->Cell(147,7,"ACTA DE EXAMEN PROFESIONAL",0,1,'C');
                    $pdf->Ln(16);
  ...
  $pdf->Output('ActadeExamenFrente.pdf','I');
