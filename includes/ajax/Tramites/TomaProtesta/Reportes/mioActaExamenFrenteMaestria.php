      ...
      if($result){
        ...
        if($row['fk_titulacion']==2){
          ...
          $opciondetitulo=$titulado;
                 ...
                 $name_sin_acentos = preg_replace('&ntilde;', 'Ñ',$Funciones->TruncateTilde($nombreAlumno) );
