...
//
 ...
 $result = $consulta->verTrabajadores();
...
<?php do { ?>        
        <tr>
            ...
            <td class="center" style="width: 100px;">               
                <a data-toggle="modal" href="#Edituser" class="btn btn-info"  onClick="EditUsuer('<?php echo $user_row['pk_rel_trbajadorescarreras']?>')"><i class="icon-edit"></i></a>
                <a class="btn btn-danger"  onclick="Borrartrabajador('<?php echo $user_row['pk_rel_trbajadorescarreras']?>')"><i class=" icon-trash"></i></a>
            </td>
        </tr>
