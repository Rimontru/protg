...
date_default_timezone_set("America/Mexico_City");
$today = date("d-m-Y");
$Nomb_Archivo = 'ReporteInformacionPersonalXLS_' . $today . '.xls';
    ...
    <td width="79">&nbsp;</td>
        ...
        <table width="1151" border="0" align="center"   id="Exportar_a_Excel">
          ...
          <tr>
            ...
            <td align="center" bgcolor="#999999"  width="111" rowspan="2"><p>Curp</p></td>
            <td align="center" bgcolor="#999999"  width="111" rowspan="2"><p>Nacimiento</p></td>
          </tr>
          <tr>
