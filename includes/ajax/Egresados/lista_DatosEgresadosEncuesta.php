                                ...
                                <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered datatables" id="example">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width: 130px;">Llenar Encuesta</th>
                                        </tr>
                                    </thead>
                                    <tbody>
<?php do { ?>        
        <tr>
            ...
            <td class="center" style="width: 100px;">               
                <a data-toggle="modal" href="#InstitucionEdit" class="btn btn-info"  onClick="ModificarEncuestaEgresados('<?php echo $alumnos_row['pk_alumno']?>')"><i class="icon-edit"></i></a>
            </td>
        </tr>
