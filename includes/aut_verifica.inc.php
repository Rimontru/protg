...
//$sql = "SELECT * FROM $sql_tabla WHERE usuario='".$_POST['user']."'";
 ...
 if (mysql_num_rows($usuario_consulta) != 0) {
    ...
    //checamos que no exista otro usuario en linea
    //if($usuario_datos['Usuario_Online'] == 1){
    //    header ("Location: ".Config::PAG_ADMIN."?error_login=7");
    //    exit;}
    ...
    $_SESSION['nombre_usuario']=$usuario_datos['Nombre'];  
